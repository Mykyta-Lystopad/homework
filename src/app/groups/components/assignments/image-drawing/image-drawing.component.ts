import { Component, EventEmitter, Input, OnChanges, OnInit, Output, SimpleChanges, TemplateRef, ViewChild, ElementRef } from '@angular/core';
...
export class ImageDrawingComponent implements OnInit, OnChanges {
    ...
    public redo() {
        if (this.canRedo) {
            ...
            if (firstInStack) {
                this.canvas.insertAt(firstInStack, this.canvas.getObjects().length , false);////-1
            }
            this.setUndoRedo();
        }
    }
